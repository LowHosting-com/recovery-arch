...
lowhosting() {
	printf 'Waiting for system to be up and running...'
	systemctl is-system-running --wait

	printf "Cloning repositories..."
	git clone https://github.com/LowHosting-com/installimage.git

	printf "Mounting images repository..."
	mkdir -p remote
	mount -vvvv  66.118.245.38:/var/nfs/general ./remote
